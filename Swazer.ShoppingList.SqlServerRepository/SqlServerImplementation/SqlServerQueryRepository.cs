...
using Swazer.ShoppingList.SqlServerRepository.Queries;
...
{
    public class SqlServerQueryRepository : IGenericQueryRepository
    {
        ...
        private Expression<Func<TBusinessEntity, bool>> CreatePredicate<TBusinessEntity>(ShoppingListContext context, int id)
        {
