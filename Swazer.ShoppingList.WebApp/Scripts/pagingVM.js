function PagingVM(options) {
    ...
    self.SortingDirection = ko.observable(options.sortingDirection);
    self.SortColumn = ko.observable(options.sortColumn);

    self.ToggleDirection = function () {
        if (self.SortingDirection() === self.Asc)
            return self.SortingDirection(self.Desc);
        else if (self.SortingDirection() === self.Desc)
            return self.SortingDirection(self.Asc);
    }
    ...
    self.IsAscending = ko.pureComputed(function () {
        return (self.SortingDirection() === self.Asc);
    })

    self.IsDescending = ko.pureComputed(function () {
        return (self.SortingDirection() === self.Desc);
    });
    ...
    self.SetCurrentPage = function (page) {
        ...
        if (self.LastPage() > 0 && page > self.LastPage())
            page = self.LastPage();
    ...
    self.toSubmitModel = function () {
        return {
            ...
            SortingDirection: self.SortingDirection(),
    ...
    self.updateSearchCriteria = function (e) {
        ...
        self.SetCurrentPage(e.SearchCriteriaModel.CurrentPage);
    };
