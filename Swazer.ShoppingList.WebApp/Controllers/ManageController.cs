...
namespace Swazer.ShoppingList.WebApp.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            get { return _userManager ?? HttpContext.GetOwinContext().GetUserManager<UserService>(); }
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            IdentityResult result = await UserManager.ChangePhoneNumberAsync(User.Identity.GetUserId<int>(), model.PhoneNumber, model.Code);
            if (result.Succeeded)
            {
                User user = await UserManager.FindByIdAsync(User.Identity.GetUserId<int>());
                if (user != null)
        ...
        {
            IdentityResult result = await UserManager.SetPhoneNumberAsync(User.Identity.GetUserId<int>(), null);
            if (!result.Succeeded)
            {
        ...
        public async Task<ActionResult> ManageLogins(ManageMessageId? message)
        {
            ...
            IList<UserLoginInfo> userLogins = await UserManager.GetLoginsAsync(User.Identity.GetUserId<int>());
        ...
        {
            User user = UserManager.FindById(User.Identity.GetUserId<int>());
            if (user != null)
            {
