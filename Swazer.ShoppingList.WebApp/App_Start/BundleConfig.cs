...
namespace Swazer.ShoppingList.WebApp
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/homebootstrap").Include(
                "~/Content/bootstrap.min.css"
                ));

            bundles.Add(new StyleBundle("~/Content/homertl").Include(
             "~/Content/plugins/bootstrap-rtl/bootstrap-rtl.min.css"));

            bundles.Add(new StyleBundle("~/Content/home").Include(
                "~/Content/font-awesome.min.css",
                "~/Content/home/owl.carousel.min.css",
                "~/Content/animate.min.css",
                "~/Content/home/magnific-popup.css",
                "~/Content/home/style.css"));

            bundles.Add(new StyleBundle("~/Content/home-style-rtl").Include(
                "~/Content/home/style-rtl.css"
                ));

            bundles.Add(new StyleBundle("~/Content/home-repsonsive").Include(
                "~/Content/home/responsive.css"));

            bundles.Add(new Bundle("~/bundles/home").Include(
                "~/Scripts/home/wow.min.js",
                "~/Scripts/home/jquery.waypoints.min.js",
                "~/Scripts/bootstrap.js",
                "~/Scripts/respond.min.js",
                "~/Scripts/home/owl.carousel.min.js",
                "~/Scripts/home/modernizr.custom.js",
                "~/Scripts/home/jquery.magnific-popup.min.js",
            ...
            bundles.Add(new StyleBundle("~/Content/datetimepicker").Include(
              "~/Content/plugins/datetime/bootstrap-datetimepicker.css"));
            ...
            InspiniaBundles(bundles);
        }

        private static void InspiniaBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/plugins/nprogressStyle").Include(
                      "~/Content/plugins/nprogress/nprogress.min.css"));
            ...
            // nestable styles
            bundles.Add(new StyleBundle("~/plugins/nestableStyles").Include(
            ...
            bundles.Add(new StyleBundle("~/Content/plugins/colorpicker/colorpickerStyles").Include(
                      "~/Content/plugins/colorpicker/css/bootstrap-colorpicker.min.css"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/select2").Include(
                      ...
                      "~/Scripts/plugins/select2/i18n/ar.js"));
