...
namespace Swazer.ShoppingList.Core
{
    ...
    public class EntityNotFoundException : Exception
    {
        ...
        public string Title => "Business Entity Not Found";

        public string Description => "Trying to access business entity that either don't have access to, or not exists.";
