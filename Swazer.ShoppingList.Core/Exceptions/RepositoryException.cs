...
namespace Swazer.ShoppingList.Core
{
    ...
    public class RepositoryException : Exception
    {
        ...
        public string Title => "Retrieving or Persisting Entity Error";

        public string Description => "You may have an error while accessing external persistence media (Database or Web Service).";
        ...
        public RepositoryException(string entityName, ErrorTypeEnum errorType)
            : base($"Error [{entityName}] has been occurred while retrieving or persisting [{errorType}] entity.")
        {
